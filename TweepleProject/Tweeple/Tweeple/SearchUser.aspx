        ...
        <div class="container" >
            <div class="row">
              ...
              <div id="searchcontent" style="width:750px;height:600px;float:right;">
                        <div id="content" style="width:500px;height:600px;float:right;">
                        <asp:datalist ID="dtsearchcontent" runat="server" Width="500" Height="600"  
                                RepeatColumns="1" RepeatDirection="Horizontal" 
                                onitemcommand="dtsearchcontent_ItemCommand"> 
                               
    <itemtemplate>
     <table style="text-align:left;">
      <tr>
                        <td>
                            <asp:image ID="Image1" imageurl='<%#"~/ImageHandler1.ashx?ID="+Eval("user_id") %>' runat="server" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <asp:Button ID="Button1" class="myButton" Text="Follow" runat="server" CommandName="passUserId" CommandArgument='<%#Eval("[user_id]") %>' />
                        </td>
                    </tr>
